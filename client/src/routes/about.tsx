      ...
      <section className="py-24 border-b border-(--border-color)">
        <div className="mx-auto max-w-3xl px-6">
          ...
          >
            <motion.p
              variants={item}
              className="font-mono text-xs tracking-widest text-(--brand-primary) uppercase mb-6"
            >
              About Vestly
            </motion.p>
            <motion.h1
              variants={item}
              className="font-serif font-bold text-[clamp(40px,5vw,60px)] leading-[1.08] tracking-[-0.02em] text-(--text-primary) mb-8"
            >
            ...
            <motion.p
              variants={item}
              className="text-[clamp(14px,1.6vw,17px)] text-(--text-light) leading-[1.75] max-w-xl"
            >
